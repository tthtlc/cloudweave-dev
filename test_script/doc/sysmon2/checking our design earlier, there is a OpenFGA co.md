...
# checking our design earlier, there is a OpenFGA component that authorized different level of roles to different path in the libcloud REST API.    please fill in this part, as it is missing from above design.
...
This design keeps the tuple count at **O(users × roles)** rather than **O(users × API paths)**, which is the correct OpenFGA pattern for RBAC at scale.[^1][^2]

<div align="center">⁂</div>

[^1]: https://openfga.dev/docs/concepts

[^2]: https://openfga.dev/docs/interacting/managing-relationships-between-objects
