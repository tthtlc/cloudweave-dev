...
# Resolve SCRIPT_DIR/REPO_ROOT for the common case of a direct `source`.
...
_lldap_load_env_file "${REPO_ROOT}/.env"
_lldap_load_env_file "${REPO_ROOT}/lldap/.env" 2>/dev/null || true
_lldap_load_env_file "${REPO_ROOT}/test_script/generated/dex.env" 2>/dev/null || true
_lldap_load_env_file "${REPO_ROOT}/vault/generated/vault.env" 2>/dev/null || true
...
: "${LLDAP_AUDIT_LOG:=${REPO_ROOT}/generated/lldap_audit.log}"
