...
_vault_load_env_file "${REPO_ROOT}/.env"
_vault_load_env_file "${REPO_ROOT}/vault/generated/vault.env" 2>/dev/null || true
_vault_load_env_file "${REPO_ROOT}/test_script/generated/vault.env" 2>/dev/null || true

: "${VAULT_ADDR:=http://localhost:8200}"
VAULT_ADDR="${VAULT_ADDR%/}"
export VAULT_ADDR
: "${VAULT_AUDIT_LOG:=${REPO_ROOT}/generated/vault_audit.log}"
