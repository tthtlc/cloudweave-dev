...
_load_env_file "${ROOT}/../lldap/.env" 1 2>/dev/null || true
_load_env_file "${ROOT}/generated/dex.env" 1 2>/dev/null || true
...
LLDAP_AUDIT_LOG="${LLDAP_AUDIT_LOG:-${ROOT}/generated/lldap_audit.log}"
