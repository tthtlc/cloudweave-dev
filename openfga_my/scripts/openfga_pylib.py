...
def bootstrap_env() -> None:
    load_env_files([
        ROOT / ".env",
        ROOT / "generated" / "dex.env",
        ROOT / "generated" / "fga.env",
        ROOT / ".." / "dex" / "generated" / "dex.env",
        ROOT / ".." / "lldap" / ".env",
    ])
...
def resolve_fga_token() -> Optional[str]:
    ...
    jp = ROOT / "generated" / "tokens" / "superadmin.jwt"
...
def audit(line: dict) -> None:
    log = Path(os.environ.get("FGA_AUDIT_LOG", str(ROOT / "generated" / "openfga_audit.log")))
